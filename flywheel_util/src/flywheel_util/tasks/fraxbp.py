...
@task(persist_result=True, cache_key_fn=lambda *args: 'pools', cache_expiration=timedelta(days=1)) 
...
@task(persist_result=True, cache_key_fn=lambda *args: 'pool_snaps_raw', cache_expiration=timedelta(days=1)) 
...
@task(persist_result=True, cache_key_fn=lambda *args: 'pool_snaps_vol_raw', cache_expiration=timedelta(days=1)) 
...
@task(persist_result=True, cache_key_fn=lambda *args: 'convex_yield', cache_expiration=timedelta(days=1))
...
@task(persist_result=True, cache_key_fn=lambda *args: 'metapool_asset_eco_vol', cache_expiration=timedelta(days=1)) 
